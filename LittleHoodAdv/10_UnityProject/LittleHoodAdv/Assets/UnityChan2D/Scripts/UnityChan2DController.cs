...
//        m_rigidbody2D.linearVelocity = new Vector2(move * maxSpeed, m_rigidbody2D.linearVelocity.y);

//        m_animator.SetFloat("Horizontal", move);
//        m_animator.SetFloat("Vertical", m_rigidbody2D.linearVelocity.y);
...
//        m_rigidbody2D.linearVelocity = new Vector2(transform.right.x * backwardForce.x, transform.up.y * backwardForce.y);
